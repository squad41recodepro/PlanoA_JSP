...
<body class="text-monospace">
  ...
  <main align="center">
    ...
    <section class="container-fluid">
      <br>
      <!-- inicio cards de opçoes-->

      <div class="row">
        <!-- linha 1 dos cards de opçoes-->
        <div class="col">
          <!-- coluna 1-->
          <div class="card">
        ...
        <div class="col">
          <!-- coluna 2-->
          <div class="card">
            <img src="./imagens/planosDeAula/Imagem_Material_Folha-de-redação.png" class="card-img-top" alt="...">
            <div class="card-body">
              <h5 class="card-title">Técnicas de Redação</h5>
              <h6 class="card-title">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Praesentium, perspiciatis
                minima magnam ea suscipit mollitia voluptatibus commodi! Facere</h6>
              <p class="card-text">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Praesentium, perspiciatis
                minima magnam ea suscipit mollitia voluptatibus commodi! Facere</p>
      ...
      </div> <!-- fim da linha 1 dos cards de opçoes-->
      ...
      <div class="row">
        ...
        <div class="col">
          <!-- coluna 4-->
          <div class="card">
            <img src="./imagens/planosDeAula/HISTÓRIA.jpg" class="card-img-top" alt="...">
            <div class="card-body">
      ...
      <div class="row">
        ...
        <div class="col">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <h5 class="card-title">Ciências</h5>
              <h6 class="card-title">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Praesentium, perspiciatis
                minima magnam ea suscipit mollitia voluptatibus commodi! Facere</h6>
              <p class="card-text">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Praesentium, perspiciatis
                minima magnam ea suscipit mollitia voluptatibus commodi! Facere</p>
        ...
        <!-- fim da linha 1 dos cards de opçoes-->
    ...
    </section> <!-- fim dos cards de opçoes-->
