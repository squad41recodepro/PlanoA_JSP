    ...
    <section>
      <div class="container py-5 p-3">
        <div class="container-fluid mt-4 p-5 text-black rounded">
          <h1 class="display-5 fw-bold text-center textoMarinho">Sobre Nós</h1>
        </div>
        <p class="textoNeutroCinza text-center text-monospace fs-4">Nós, da Plano A, acreditamos que os planos para um
          futuro
          melhor, passam pela democratização do conhecimento.
          Promovemos a troca de experiências e aprendizado entre educadores da educação básica, atuantes na rede pública
          brasileira, visando o enriquecimento de seus repertórios dentro de sala de aula.
          Buscamos colaborar para a diminuição da desigualdade social, por meio de uma educação inclusiva e justa,
          gerando oportunidades igualitárias e tendo o professor como agente ativo dessa transformação.
        </p>
      </div>
    </section>
      ...
      <div class="container py-5 p-3">
        <div class="row fs-1 textoMarinho">
          <div class="col-lg-4 text-center">
            ...
            <h2 class="text-monospace textoMarinho">Missão</h2>
            <p class="text-monospace textoNeutroCinza fs-4">Promover equiparidade educacional por meio da troca de
              experiências e disseminação de informação.</p>
          </div><!-- /.col-lg-4 -->
          <div class="col-lg-4 text-center">
            <i class="bi bi-book-half"></i>
            <h2 class="text-monospace textoMarinho">Visão</h2>
            <p class="text-monospace textoNeutroCinza fs-4">Desejamos criar um aplicativo referência em termos de
              disseminação de informação e promover por meio dela maior inclusão educacional.</p>
          </div><!-- /.col-lg-4 -->
          <div class="col-lg-4 text-center">
            <i class="bi bi-mortarboard-fill"></i>
            <h2 class="text-monospace textoMarinho">Valores</h2>
            <p class="text-monospace textoNeutroCinza fs-4">Inclusão social, respeito, informação, equiparidade,
              educação colaborativa.</p>
          </div><!-- /.col-lg-4 -->
        </div><!-- /.row -->
      </div>
    </section>
